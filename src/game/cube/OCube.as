package game.cube 
{
	 ...
	 * @author Huaying
	 */
	public class OCube extends TetrisCube
	{		
		public function OCube(view:View3D) 
		{
			this.view = view;	
		}	
		public override  function createCube() : void
		{
			...
			bcube[2].position = new Vector3D(cube_unit, 0,cube_unit);
		...
		public override function createShadowCube():void
		{
			...
			scube[2].position = new Vector3D(cube_unit, 0,cube_unit);
