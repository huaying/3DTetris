package game.cube 
{
	 ...
	 * @author Huaying
	 */
	public class TCube extends TetrisCube
	{		
		public function TCube(view:View3D) 
		{
			this.view = view;	
		}	
		public override  function createCube() : void
		{
			...
			bcube[3].position = new Vector3D(cube_unit, 0, cube_unit);
		...
		public override function createShadowCube():void
		{
			...
			scube[3].position = new Vector3D(cube_unit,0 , cube_unit);
