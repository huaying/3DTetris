package game.cube 
{
	 ...
	 * @author Huaying
	 */
	public class XCube extends TetrisCube
	{		
		public function XCube(view:View3D) 
		{
			this.view = view;	
		}	
		public override  function createCube() : void
		{
			...
			bcube[2].position = new Vector3D(0, -cube_unit, 0);
		...
		public override function createShadowCube():void
		{
			...
			scube[2].position = new Vector3D(0, -cube_unit, 0);
