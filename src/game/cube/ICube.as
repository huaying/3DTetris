package game.cube 
{
	 ...
	 * @author Huaying
	 */
	public class ICube extends TetrisCube
	{		
		public function ICube(view:View3D) 
		{
			this.view = view;	
		}	
		public override  function createCube() : void
		{
			...
			bcube[3].position = new Vector3D(-cube_unit, 0, 0);
		...
		public override function createShadowCube():void
		{
			...
			scube[3].position = new Vector3D(-cube_unit, 0, 0);
