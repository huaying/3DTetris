package game.cube 
{
	 ...
	 * @author Huaying
	 */
	public class ZCube extends TetrisCube
	{		
		public function ZCube(view:View3D) 
		{
			this.view = view;	
		}	
		public override  function createCube() : void
		{
			...
			bcube[1].position = new Vector3D(0, -cube_unit, 0);
			bcube[2].position = new Vector3D(cube_unit, -cube_unit, 0);
			bcube[3].position = new Vector3D(cube_unit, -cube_unit, -cube_unit);
	
			ror_origin = bcube[1].position;
		...
		public override function createShadowCube():void
		{
			...
			scube[1].position = new Vector3D(0, -cube_unit, 0);
			scube[2].position = new Vector3D(cube_unit, -cube_unit, 0);
			scube[3].position = new Vector3D(cube_unit, -cube_unit, -cube_unit);
